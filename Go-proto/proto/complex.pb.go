...
type Class struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Teacher       *Person                `protobuf:"bytes,1,opt,name=teacher,proto3" json:"teacher,omitempty"`
	Students      []*Person              `protobuf:"bytes,2,rep,name=students,proto3" json:"students,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Class) GetTeacher() *Person {
	if x != nil {
		return x.Teacher
	}
	return nil
...
func (x *Class) GetStudents() []*Person {
	if x != nil {
		return x.Students
	}
	return nil
...
const file_complex_proto_rawDesc = "" +
	...
	"\x05Class\x121\n" +
	"\ateacher\x18\x01 \x01(\v2\x17.example.complex.PersonR\ateacher\x123\n" +
	"\bstudents\x18\x02 \x03(\v2\x17.example.complex.PersonR\bstudentsB\x1dZ\x1bgithub.com/hadi/myapp/protob\x06proto3"
...
var file_complex_proto_goTypes = []any{
	(*Person)(nil), // 0: example.complex.Person
	(*Class)(nil),  // 1: example.complex.Class
}
var file_complex_proto_depIdxs = []int32{
	0, // 0: example.complex.Class.teacher:type_name -> example.complex.Person
	0, // 1: example.complex.Class.students:type_name -> example.complex.Person
